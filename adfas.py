...
random_forest_model = load('posisi\\model_files\\best_rf_model.joblib')
...
Scalerrandomforest = load("posisi\model_files\scalerrandomforest.joblib")
...
kmeans_modelall = load('posisi\model_files\kmeans_all.joblib')
scalerall = load("posisi\model_files\standardsclaeall.joblib")
pcaall = load("posisi\model_files\pcaall.joblib")
...
def get_leagues():
    ...
    df = pd.read_csv('posisi\model_files\players_22.csv')
...
def get_player_info():
    ...
    player_df0 = pd.read_csv('posisi\model_files\players_22.csv')
    ...
    cluster_df = pd.read_csv('posisi\model_files\player_cluster_all.csv')
